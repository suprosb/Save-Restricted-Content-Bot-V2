...
async def token_handler(client, message):
    ...
    if len(message.command) <= 1:
        ...
        join_button = InlineKeyboardButton("Join Channel", url="https://t.me/now_botupdate")
        premium = InlineKeyboardButton("Get Premium", url="https://t.me/akash_roy_official")  # Callback for Help button
